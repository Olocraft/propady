        ...
        <div className="max-w-3xl">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              <span className="text-gradient">The Future of Real Estate and RWAs:</span>
            </h1>
          ...
          >
            Propady is a marketplace for buying, selling and managing properties. Building on the blockchain technology to enhance transparency and security, making real estate investing accessible to everyone.
          </motion.p>
          ...
          >
            <Button 
              className="bg-propady-purple hover:bg-propady-purple-light text-white px-8 py-6 rounded-xl text-lg font-medium"
            >
              Join our Waitlist
            </Button>
            <Button 
      ...
      >
        ...
        <div className="p-4">
          <div className="flex justify-between items-start">
            <div>
              <h3 className="font-semibold text-lg text-white">Bungalow Terrace</h3>

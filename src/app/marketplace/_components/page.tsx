...
const Marketplace = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      const results = await searchProperties({
        ...
        location:
          filtersApplied && selectedLocations.length > 0
  ...
  useEffect(() => {
    if (activeTab !== "land") {
      const filtered = properties.slice(
        0,
      ...
      <div className="pt-28 pb-10 container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-xl text-white mt-2">
            Today&apos;s Top Listed Props close to you
          </h2>
        </motion.div>
